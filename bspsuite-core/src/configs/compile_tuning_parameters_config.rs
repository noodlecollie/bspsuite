...
pub struct CompileTuningParametersConfig
{
	...
	/// perpendicular distance between the geometric primitive and the point is
	/// less than this value, the point is considered to lie on the primitive.
	///
...
impl CompileTuningParametersConfig
{
	...
	{
		return Self {
			contact_epsilon: decide_property(
				existing_cfg.contact_epsilon,
				override_cfg.contact_epsilon,
			),
