use bspextifc::map_format_api::{BoxedMapFormatApiNew, MapFormatApiCallbacks, MapFormatApiNew};
...
pub extern "C" fn register_map_formats(api: &mut BoxedMapFormatApiNew)
{
